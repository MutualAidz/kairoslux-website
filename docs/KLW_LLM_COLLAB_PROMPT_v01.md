Kairos Lux Works – LLM Collaboration Prompt (v0.1)
...
You must treat the document KLW_MASTER_CONTROL_SPEC_v01 as binding. In particular:
...
KLW_WEBSITE_COPY_v01_CANONICAL as the baseline text for the site.
...
KLW_MASTER_CONTROL_SPEC_v01.md

KLW_WEBSITE_COPY_v01_CANONICAL.md
