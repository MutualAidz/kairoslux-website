...
- **Master control spec:** ./docs/KLW_MASTER_CONTROL_SPEC_v02.md
- **Canonical site copy:** ./docs/KLW_WEBSITE_COPY_v02_CANONICAL.md
- **Revision history:** ./docs/KLW_REVISION_HISTORY_v02.md
...
Before making content changes:
    ...
    Read docs/KLW_MASTER_CONTROL_SPEC_v02.md

    Use only approved language from docs/KLW_WEBSITE_COPY_v02_CANONICAL.md

After making changes:

    Update docs/KLW_REVISION_HISTORY_v02.md with what changed and why.
